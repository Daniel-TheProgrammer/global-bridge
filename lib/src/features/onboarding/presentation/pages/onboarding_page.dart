...
class _HeroCardVisual extends StatelessWidget {
  const _HeroCardVisual();
      ...
      child: Container(
        ...
        child: const Row(
          ...
          children: [
            ...
            SizedBox(width: 8),
            Icon(Icons.arrow_forward, color: Color(0xFF0A1213), size: 20),
          ],
        ),
      ),
    );
