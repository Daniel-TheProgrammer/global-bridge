...
import 'package:globalbridge/src/features/auth/presentation/widgets/verification_ui_components.dart';
...
class FaceVerificationPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return VerificationPageScaffold(
      gradientCenter: const Alignment(0, -0.2),
      gradientRadius: 1.08,
      gradientColors: [
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              FrostedCircleIconButton(
                buttonKey: const Key('face_verification_close'),
                icon: Icons.close,
          ...
          Center(
            child: _scanRing(
              child: Icon(
                Icons.portrait,
                size: 210,
                color: const Color(0xFFE7ECF3).withValues(alpha: 0.55),
              ),
            ),
          ),
                    ...
                    child: SizedBox(
                      ...
                      child: Row(
                        children: [
                          Expanded(
                            flex: 65,
                            child: Container(color: const Color(0xFF24CFE3)),
                          ),
                          Expanded(
                            flex: 35,
                            child: Container(color: const Color(0x33495F79)),
                          ),
                        ],
                      ),
                    ),
          ...
          const SizedBox(height: 10),
          const Center(child: BottomGrabHandle()),
        ],
      ),
    );
  }
    ...
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          ...
          const ScanFrameCorner(alignment: Alignment.topLeft, size: 30),
          const ScanFrameCorner(alignment: Alignment.topRight, size: 30),
          const ScanFrameCorner(alignment: Alignment.bottomLeft, size: 30),
          const ScanFrameCorner(alignment: Alignment.bottomRight, size: 30),
        ],
      ),
    );
  }
